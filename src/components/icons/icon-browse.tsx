...
const Browse = (props: SVGProps<SVGSVGElement>): JSX.Element => (
	<svg data-encore-id="icon" role="img" aria-hidden="true" fill="#fff" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid" {...props}>
